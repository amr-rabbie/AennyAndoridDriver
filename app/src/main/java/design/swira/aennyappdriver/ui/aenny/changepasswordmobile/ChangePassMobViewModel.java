...
public class ChangePassMobViewModel extends AndroidViewModel {
    ...
    MutableLiveData<DriverResponse> changepasswordMutableLiveData=new MutableLiveData<>();
    ...
    public void PostChangeClientPassword(String mobile , String oldpassword , String newpassword){
        ApiClient.getInstance().PostchangeClientPassword(mobile,oldpassword,newpassword).enqueue(new Callback<DriverResponse>() {
            @Override
