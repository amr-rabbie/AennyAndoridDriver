...
public class TripsResponse{
	...
	public TripsResponse(double tripCost, double tripDestinationLatt, String tripDestination, double tripDestinationLong,  String tripTime, double tripPickupLong,    int tripTypeId, int healthyNumber, String tripPickup,  String tripDate,   double tripPickupLatt, double tripDistance, String visaNumber, int tripStatus, int clientId, int handicappedNumber) {
		this.tripCost = tripCost;
		this.tripDestinationLatt = tripDestinationLatt;
		this.tripDestination = tripDestination;
		this.tripDestinationLong = tripDestinationLong;
