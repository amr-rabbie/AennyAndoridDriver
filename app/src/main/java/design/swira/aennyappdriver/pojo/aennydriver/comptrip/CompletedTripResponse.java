...
public class CompletedTripResponse{
	...
	@SerializedName("IsAssignToDriver")
	private boolean isAssignToDriver;
	...
	@SerializedName("Goverment_Name")
	private Object govermentName;
	...
	private String tripDestinationDate;
	...
	public void setTripsRates(TripsRates tripsRates){
		this.tripsRates = tripsRates;
	}

	public TripsRates getTripsRates(){
		return tripsRates;
	}
	...
	public void setTripDestinationTime(String tripDestinationTime){
		this.tripDestinationTime = tripDestinationTime;
	}

	public String getTripDestinationTime(){
	...
	public void setIsAssignToDriver(boolean isAssignToDriver){
		this.isAssignToDriver = isAssignToDriver;
	}

	public boolean isIsAssignToDriver(){
		return isAssignToDriver;
	}
	...
	public void setGovermentName(Object govermentName){
		this.govermentName = govermentName;
	}

	public Object getGovermentName(){
	...
	public void setTripDestinationDate(String tripDestinationDate){
		this.tripDestinationDate = tripDestinationDate;
	}

	public String getTripDestinationDate(){
	...
	@Override
 	public String toString(){
		return 
			...
			",isAssignToDriver = '" + isAssignToDriver + '\'' + 
			",trip_Pickup = '" + tripPickup + '\'' + 
			",trip_Key = '" + tripKey + '\'' + 
			",trip_Date = '" + tripDate + '\'' + 
			",vehicle_Id = '" + vehicleId + '\'' + 
			",goverment_Name = '" + govermentName + '\'' + 
