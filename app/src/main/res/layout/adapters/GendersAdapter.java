...
public class GendersAdapter  extends BaseAdapter {
    Context context; List<Genders> cityList;
    public GendersAdapter(Context context, List<Genders> cityList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        holder.name.setText(cityList.get(i).getGenderName());
